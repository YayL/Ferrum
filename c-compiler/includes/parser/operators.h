...
#define OPERATORS_LIST(f) \
    ...
    \
    f(PRE_INCREMENT, UNARY_PRE, 2, LEFT, NORMAL, "++") \
    f(POST_INCREMENT, UNARY_POST, 2, LEFT, NORMAL, "++") \
    f(PRE_DECREMENT, UNARY_PRE, 2, LEFT, NORMAL, "--") \
    f(POST_DECREMENT, UNARY_POST, 2, LEFT, NORMAL, "--") \
    \
